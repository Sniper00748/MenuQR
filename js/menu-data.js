...
const menuData = {
    ...
    items: [
        // 经典鸡尾酒
        {
            ...
            ingredients: "金酒、汤力水",
            stats: {alcohol: 2, sweetness: 2, acidity: 1, bitterness: 3, complexity: 1, body: 1}
        },
        {
            id: 102,
            categoryId: 1,
            ...
            stats: {alcohol: 2, sweetness: 3, acidity: 3, bitterness: 1, complexity: 2, body: 1}
        },
        {
            id: 103,
            categoryId: 1,
            ...
            stats: {alcohol: 3, sweetness: 4, acidity: 3, bitterness: 1, complexity: 2, body: 2}
        },
        {
            id: 104,
            categoryId: 1,
            ...
            stats: {alcohol: 4, sweetness: 3, acidity: 4, bitterness: 1, complexity: 2, body: 2}
        },
        {
            id: 105,
            categoryId: 1,
            ...
            stats: {alcohol: 4, sweetness: 4, acidity: 1, bitterness: 2, complexity: 2, body: 3}
        },
        {
            id: 106,
            categoryId: 1,
        ...
        },
        {
            ...
            stats: {alcohol: 3, sweetness: 5, acidity: 3, bitterness: 1, complexity: 3, body: 5}
        },
        {
            id: 108,
            categoryId: 1,
            ...
            stats: {alcohol: 4, sweetness: 1, acidity: 5, bitterness: 2, complexity: 4, body: 2}
        },
        {
            id: 109,
            categoryId: 1,
            ...
            stats: {alcohol: 3, sweetness: 3, acidity: 4, bitterness: 1, complexity: 3, body: 3}
        },
        {
            id: 110,
            categoryId: 1,
            ...
            stats: {alcohol: 2, sweetness: 4, acidity: 3, bitterness: 1, complexity: 1, body: 2}
        },
        {
            id: 111,
            categoryId: 1,
            ...
            stats: {alcohol: 4, sweetness: 2, acidity: 5, bitterness: 1, complexity: 3, body: 2}
        },
        {
            id: 112,
            categoryId: 1,
        ...
        },
        {
            ...
            stats: {alcohol: 0, sweetness: 4, acidity: 3, bitterness: 1, complexity: 2, body: 2}
        },
        // 来生专属
        {
            id: 201,
            ...
            stats: {alcohol: 3, sweetness: 3, acidity: 4, bitterness: 1, complexity: 1, body: 1}
        },
        {
            id: 202,
            categoryId: 2,
            ...
            description: "夜城霓虹下的烈焰灵魂，酸爽清冽带着一点爱，致敬夜之城那位真正的大人物",
            ingredients: "伏特加、青柠汁、干姜水、樱花可乐",
            stats: {alcohol: 2, sweetness: 4, acidity: 3, bitterness: 1, complexity: 2, body: 1}
        },
        {
            id: 203,
            categoryId: 2,
            ...
            stats: {alcohol: 4, sweetness: 2, acidity: 1, bitterness: 3, complexity: 3, body: 2}
        },
        {
            id: 204,
            categoryId: 2,
            ...
            stats: {alcohol: 4, sweetness: 4, acidity: 4, bitterness: 2, complexity: 5, body: 3}
        },
        {
            id: 205,
            categoryId: 2,
            ...
            stats: {alcohol: 3, sweetness: 4, acidity: 3, bitterness: 2, complexity: 4, body: 3}
        },
        {
            id: 206,
            categoryId: 2,
            ...
            stats: {alcohol: 5, sweetness: 2, acidity: 1, bitterness: 4, complexity: 5, body: 3}
        },
        // 季节限定
        {
            id: 301,
            ...
            stats: {alcohol: 3, sweetness: 2, acidity: 2, bitterness: 3, complexity: 3, body: 1}
        },
        {
            id: 302,
            categoryId: 3,
            ...
            stats: {alcohol: 3, sweetness: 2, acidity: 3, bitterness: 2, complexity: 3, body: 1}
        }
    ]
};